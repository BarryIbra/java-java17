...
public class Stream_05_Test {
    ...
    public void monitor_imperativeSum_vs_iterateSum_vs_parallelIterateSum() {
        Logger.getAnonymousLogger().info("imperativeSum => " + monitor(n->imperativeSum(n),NB)+/* TODO */" ms");
        Logger.getAnonymousLogger().info("iterateSum => " +  monitor(n->iterateSum(n),NB)+/* TODO */" ms");
        Logger.getAnonymousLogger().info("parallelIterateSum => " +  monitor(n->parallelIterateSum(n),NB)+/* TODO */ " ms");
    }

    // Quel résultat obtenez-vous ?
    
    // INFO: imperativeSum => 2 ms
    // INFO: iterateSum => 80 ms
    // INFO: parallelIterateSum => 292 ms
    ...
    public void monitor_imperativeSum_vs_iterateSum_vs_parallelIterateSum_vs_rangeSum_vs_rangeParallelSum() {
        ...
        Logger.getAnonymousLogger().info("iterateSum => " +monitor(n->iterateSum(n),NB)+ /* TODO */ " ms");
        Logger.getAnonymousLogger().info("parallelIterateSum => " + monitor(n->parallelIterateSum(n),NB)+/* TODO */ " ms");
        Logger.getAnonymousLogger().info("rangeSum => " + monitor(n->rangeSum(n),NB)+/* TODO */" ms");
        Logger.getAnonymousLogger().info("rangeParallelSum => " /* TODO */ + monitor(n->rangeParallelSum(n),NB)+" ms");
    }

    // Quel résultat obtenez-vous ?
    
    // INFO: imperativeSum => 2 ms
    // INFO: iterateSum => 83 ms
    // INFO: parallelIterateSum => 313 ms
    // INFO: rangeSum => 2 ms
